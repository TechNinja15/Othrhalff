      ...
      <div className="relative z-10 px-5 md:px-8 py-10 md:py-16 max-w-4xl mx-auto flex flex-col items-center w-full pb-28 md:pb-12">
        ...
        <div className={`text-center mb-4 transition-all duration-700 delay-100 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          <h1 className="text-5xl md:text-7xl font-black tracking-[-0.04em] leading-tight uppercase flex items-center justify-center gap-3 md:gap-4">
            <span className="bg-gradient-to-r from-white via-gray-100 to-gray-400 bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(255,255,255,0.1)]">AMI</span>
            <span className="bg-gradient-to-r from-neon via-pink-400 to-purple-400 bg-clip-text text-transparent drop-shadow-[0_0_40px_rgba(255,0,127,0.3)]">SPARK</span>
          </h1>
        </div>
